window.onload = function () {
    document.getElementById("searchButton").onclick = function () {
        ...
        var map = 0;
        // map = L.map('map'); //ここが原因でリセット必要、ここなくすと上書き、ドラッグもできる
        ...
        // console.log(String(document.getElementsByClassName("leaflet-overlay-pane")));
        // console.log(document.getElementsByClassName("leaflet-overlay-pane"));
        // let temp = document.getElementsByClassName("leaflet-zoom-animated");
        // console.log(temp[0]);

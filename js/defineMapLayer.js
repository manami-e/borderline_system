...
const bingApiKey = 'AtYQ_kBscZS4-m07EuXWJxjFlg_CGRYPgqpJcB9y-ZAZnYt9CxYu-7XUF4w8of__';
const mapboxApiKey = 'pk.eyJ1IjoibWFuYW1pODg2MSIsImEiOiJja3B3YXdldTkwNWwzMnduMHJqYWhyeDg4In0.9E2ANESTu_0aEio5Byw0yA';
...
let mapboxRoadLayer = new ol.layer.VectorTile({
	...
	style: function (feature, resolution) {
		...
		line_width.addEventListener('change', valueChange);
...
let mapboxAdminLayer = new ol.layer.VectorTile({
	source: new ol.source.VectorTile({
		...
		format: new ol.format.MVT({ layers: "administrative + admin_level=8" }),
		url: 'https://{a-d}.tiles.mapbox.com/v4/mapbox.mapbox-streets-v7/{z}/{x}/{y}.vector.pbf?access_token=' + mapboxApiKey,
	}),
	renderMode: "image",
	style: function (feature, resolution) {
